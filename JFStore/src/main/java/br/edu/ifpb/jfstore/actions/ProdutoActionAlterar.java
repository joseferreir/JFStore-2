 ...
 * @author José
 */
public class ProdutoActionAlterar implements Action {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Produto produtooriginal = (Produto) request.getSession().getAttribute("produto");
            int idProdutoOrininal = produtooriginal.getId();
                produtooriginal = alterarProduto(request);
                produtooriginal.setId(idProdutoOrininal);
                
            Map<String, String> resultado = fachada.alterar(produtooriginal);
    ...
    private Produto alterarProduto(HttpServletRequest request) throws IOException, IllegalStateException, ServletException {
